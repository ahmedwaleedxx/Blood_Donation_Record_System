...
//        if (name.getText().isEmpty() || id.getText().isEmpty() || age.getText().isEmpty() || bloodtype.getSelectedItem().equals("             << SELECT >>")) {
...
//                add.setString(3, bloodtype.getSelectedItem().toString());
//                add.setInt(4, Integer.valueOf(age.getText()));
...
//    }
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bloodtype, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        type.setText("patient");
        HospitalController.verifysendrequest(namee, idd, agee, btype);
        status.setText("Blood Request Pending....");
